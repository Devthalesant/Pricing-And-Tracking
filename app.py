...
df_sales_all_indicators_path = "/content/Pricing-And-Tracking/base_de_dados/sales/all_indicators_sales.csv"
df_sales_average_price_path = "/content/Pricing-And-Tracking/base_de_dados/sales/df_average_price.csv"
df_sales_contribution_margin_path = "/content/Pricing-And-Tracking/base_de_dados/sales/df_contribution_margin.csv"
df_sales_main_products_path = "/content/Pricing-And-Tracking/base_de_dados/sales/df_main_products.csv"
df_sales_quantity_sold_path = "/content/Pricing-And-Tracking/base_de_dados/sales/df_quantity_sold.csv"

# Path to the appointments indicators CSV file
df_appointments_all_indicators_path = "/content/Pricing-And-Tracking/base_de_dados/appointments/all_indicators_appointments.csv"
df_appointments_cortesy_analysis_path = "/content/Pricing-And-Tracking/base_de_dados/appointments/courtesy_analysis.csv"
df_appointments_direct_costs_path = "/content/Pricing-And-Tracking/base_de_dados/appointments/direct_costs.csv"
df_appointments_main_served_procedeures_path = "/content/Pricing-And-Tracking/base_de_dados/appointments/main_served_procedeures.csv"
df_appointmentes_time_taken_from_schedule_path = "/content/Pricing-And-Tracking/base_de_dados/appointments/time_taken_from_schedule.csv"
