...
select_options = st.selectbox("O que você quer ver de Vendas?", sales_option)

col_1, col_2 = st.columns(2)

with col_1:
    select_month = st.selectbox("Escolha o mês", Month_list)
with col_2:
    select_branch = st.selectbox("Escolha a unidade", branch_list)
